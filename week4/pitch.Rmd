...
percentiles_girls <- subset(read.table("data/wfa_girls_p_exp.txt", header = TRUE, sep="\t", stringsAsFactors = FALSE), select = c(Age, P3, P15, P50, P85, P97))[1:30,]
...
plot_ly(percentiles_girls, x = ~Age, y = ~P50, name = 'P50', type = 'scatter', mode = 'lines', line = list(color = 'black', width = 2)) %>%
    ...
    layout(title = "Girl Child weight (kg) / age (days)",
